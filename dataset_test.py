...
# plot_saxs(q, np.sqrt(np.diag(test_processing_data['Im3m'][700,:,:,0])))
# plot_saxs(q, np.sqrt(np.diag(test_processing_data['Im3m'][800,:,:,0])))
# plot_saxs(q, np.sqrt(np.diag(test_processing_data['Im3m'][900,:,:,0])))
